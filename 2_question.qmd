...
These reviews aim to investigate the human experiences or meaningfulness of an issue or phenomenon. Qualitative review questions can be expressed using the **PICo** framework: Population, Phenomena of Interest, and Context [@munnMethodologicalGuidanceSystematic2015]. The **population** consideration is similar to other question frameworks above. Note that there is no *outcome* explicitly considered in these types of reviews.
