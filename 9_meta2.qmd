...
combined <- pool.groups(n1 = data$treat_n["study_ID" = 3], 
                        n2 = data$treat_n["study_ID" = 4],
                        m1 = data$treat_mean["study_ID" = 3], 
                        sd1 = data$treat_SD["study_ID" = 3],
                        m2 = data$treat_mean["study_ID"=4], 
                        sd2 = data$treat_SD["study_ID"=4])
```
