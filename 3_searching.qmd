...
Many databases have **controlled vocabulary** (i.e., standardized subject terms) that should also be searched as part of the search strategy in addition to text words (i.e., keywords). In MEDLINE, these are called **MeSH** terms.
...
Now save the results as an RIS file. When exporting, make sure you select the abstract and keywords fields to include in your exported file.
:::
