...
Working in teams, identify one **outcome** from this review and conduct and interpret the following analyses:

-  Meta-analysis (using an appropriate summary measure)
-  Customized forest plot
-  Sub-group analysis (by intervention type, comparison type, or participant type)
-  Publication bias assessment using a funnel plot and (if appropriate) an appropriate statistical test
:::
